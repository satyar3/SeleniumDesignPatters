...
import com.qa.selenium.design.strategy.PaymentOptionFactory;
import com.qa.selenium.design.strategy.PaymentScreen;
import com.qa.selenium.design.test.BaseTest;

public class PaymentScreenTestUsingFactory extends BaseTest
{
	...
	public void paymentSCreenTest(String paymentOption, Map<String,String> paymentDetails)
	{
		this.paymentScreen.goTo();
		this.paymentScreen.getUserInfo().enterDetails("Testln", "Testln", "sasa@gmail.com");
		this.paymentScreen.setPaymentOption(PaymentOptionFactory.getPaymentOption(paymentOption));
